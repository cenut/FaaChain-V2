...
import com.faa.chain.utils.Strings;

import static com.faa.chain.crypto.SecureRandomUtils.secureRandom;
...
public class Keys {
    ...
    public static final int ADDRESS_LENGTH_FAA = 42;
    ...
    public static String getAddress(String publicKey) {
        ...
        return hash.substring(hash.length() - ADDRESS_LENGTH_FAA);

//        String hashOri = hash.substring(hash.length() - ADDRESS_LENGTH_IN_HEX);

//        StringBuilder sb = new StringBuilder(hashOri);
//        String A = hashOri.substring(28, 29);
//        String B = hashOri.substring(18, 19);
//        sb.insert(21, A);
//        sb.insert(6, B);
//        hashOri = sb.toString();
