...
//    }
    ...
    public SignedRawTransaction(String from, String to, BigInteger value, BigInteger fee, Sign.SignatureData signatureData) {
        super(from, to, value, fee);
        this.signatureData = signatureData;
    }
    ...
    public String getFrom() throws SignatureException {
        ...
        return Numeric.FAA_PREFIX + Keys.getAddress(key).toUpperCase();
    }
