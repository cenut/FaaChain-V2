...
public final class Numeric {
    ...
    public static final String FAA_PREFIX = "FW";
    public static final String FAA_TRANS_PREFIX = "FX";
    public static final String FAA_BLOCK_PREFIX = "FB";
...
//    }
    ...
    public static String cleanHexPrefix(String input) {
        if (containsHexPrefix(input) || containsFaaPrefix(input) || containsFaaTransPrefix(input)) {
    ...
    public static String prependFaaPrefix(String input) {
        input = input.toUpperCase();
        if (!containsFaaPrefix(input)) {
            return FAA_PREFIX + input;
        } else {
            return input;
        }
    }

    public static String prependFaaTransPrefix(String input) {
        return FAA_TRANS_PREFIX + input;
    }

    public static String prependFaaBlockPrefix(String input) {
        return FAA_BLOCK_PREFIX + input;
    }
    ...
    public static boolean containsFaaPrefix(String input) {
        String inputUp = input.toUpperCase();
        return inputUp.length() > 1 && inputUp.charAt(0) == 'F' && inputUp.charAt(1) == 'W';
    }

    public static boolean containsFaaTransPrefix(String input) {
        String inputUp = input.toLowerCase();
        return inputUp.length() > 1 && inputUp.charAt(0) == 'f' && inputUp.charAt(1) == 'x';
    }
...
//        String a = toHexStringZeroPadded(value, size, true);
//        System.out.println("in tohex : "+a);
//        return a;
...
//    }
    ...
    public static String toFaaString(byte[] input, int length, boolean withPrefix) {
        StringBuilder stringBuilder = new StringBuilder();
        if (withPrefix) {
            stringBuilder.append(FAA_PREFIX);
        }
